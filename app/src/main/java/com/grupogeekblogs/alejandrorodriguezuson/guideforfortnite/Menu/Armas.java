...
public class Armas extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(this, "ca-app-pub-5854979842846146/4598104610");


        String l7 = Locale.getDefault().getLanguage();

        txt_url = findViewById(R.id.textView12);
        txt_url.setText(R.string.url_armas);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_trucos:
                Intent h= new Intent(Armas.this,trucos.class);
                startActivity(h);
                break;
            case R.id.nav_mapa:
                Intent g= new Intent(Armas.this,Mapa.class);
                startActivity(g);
                break;
            case R.id.nav_armas:
                Intent i= new Intent(Armas.this,Armas.class);
                startActivity(i);
                break;
            case R.id.nav_noticias:
                Intent s= new Intent(Armas.this,Noticias.class);
                startActivity(s);
                break;
            case R.id.nav_skins:
                Intent t= new Intent(Armas.this,Skins.class);
                startActivity(t);
                break;
            case R.id.nav_twitter:
                Intent k= new Intent(Armas.this,twitterMain.class);
                startActivity(k);
                break;
            case R.id.nav_construcciones:
                Intent p= new Intent(Armas.this,Construcciones.class);
                startActivity(p);
                break;
            case R.id.nav_chat:
                Intent c= new Intent(Armas.this,Login.class);
                startActivity(c);
                break;
            case R.id.nav_share:
