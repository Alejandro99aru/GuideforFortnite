...
public class Skins extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_url.setText(R.string.url_skins);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_trucos:
                Intent h= new Intent(Skins.this,trucos.class);
                startActivity(h);
                break;
            case R.id.nav_armas:
                Intent i= new Intent(Skins.this,Armas.class);
                startActivity(i);
                break;
            case R.id.nav_noticias:
                Intent s= new Intent(Skins.this,Noticias.class);
                startActivity(s);
                break;
            case R.id.nav_skins:
                Intent t= new Intent(Skins.this,Skins.class);
                startActivity(t);
                break;
            case R.id.nav_twitter:
                Intent k= new Intent(Skins.this,twitterMain.class);
                startActivity(k);
                break;
            case R.id.nav_construcciones:
                Intent p= new Intent(Skins.this,Construcciones.class);
                startActivity(p);
                break;
            case R.id.nav_chat:
                Intent c= new Intent(Skins.this,Login.class);
                startActivity(c);
                break;
            case R.id.nav_mapa:
                Intent g= new Intent(Skins.this,Mapa.class);
                startActivity(g);
                break;
            case R.id.nav_share:
