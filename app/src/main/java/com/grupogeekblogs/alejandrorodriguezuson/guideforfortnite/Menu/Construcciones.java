...
public class Construcciones extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_url.setText(R.string.url_construcciones);

        String l7 = Locale.getDefault().getLanguage();

        MobileAds.initialize(this, "ca-app-pub-5854979842846146/8174898297");
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.nav_trucos:
                Intent h= new Intent(Construcciones.this,trucos.class);
                startActivity(h);
                break;
            case R.id.nav_mapa:
                Intent g= new Intent(Construcciones.this,Mapa.class);
                startActivity(g);
                break;
            case R.id.nav_armas:
                Intent i= new Intent(Construcciones.this,Armas.class);
                startActivity(i);
                break;
            case R.id.nav_noticias:
                Intent s= new Intent(Construcciones.this,Noticias.class);
                startActivity(s);
                break;
            case R.id.nav_skins:
                Intent t= new Intent(Construcciones.this,Skins.class);
                startActivity(t);
                break;
            case R.id.nav_twitter:
                Intent k= new Intent(Construcciones.this,twitterMain.class);
                startActivity(k);
                break;
            case R.id.nav_construcciones:
                Intent p= new Intent(Construcciones.this,Construcciones.class);
                startActivity(p);
                break;
            case R.id.nav_chat:
                Intent c= new Intent(Construcciones.this,Login.class);
                startActivity(c);
                break;
            case R.id.nav_share:
